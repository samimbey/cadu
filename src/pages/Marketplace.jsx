  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <button
        ...
        className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-[199] flex items-center gap-2 bg-primary text-primary-foreground px-4 py-3 rounded-full shadow-lg hover:bg-primary/90 transition-all"
      >
