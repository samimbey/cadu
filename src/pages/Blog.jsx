      ...
      <div className="blog-content">
        <ReactMarkdown
          components={{
            ...
            img: ({ src, alt }) => src && !src.includes('/screenshots/') ? <img src={src} alt={alt} className="rounded-xl my-6 mx-auto block max-w-sm w-full" style={{ imageRendering: 'crisp-edges' }} /> : null,
