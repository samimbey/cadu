    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-5xl mx-auto px-6">
        ...
        <motion.section initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="py-16 border-t border-border">
          <h2 className="text-2xl font-normal text-foreground mb-6" style={{ fontFamily: "Georgia, serif" }}>Fertility treatments we cover</h2>
          <div className="grid sm:grid-cols-2 gap-3">
            {["In vitro fertilization (IVF)", "Intrauterine insemination (IUI)", "Egg freezing (oocyte cryopreservation)", "Embryo storage", "Donor egg & sperm", "Surrogacy-related costs", "Fertility medications", "Genetic testing (PGT)"].map(proc => (
