export default function HeroIllustration() {
  return (
    <svg viewBox="0 0 480 420" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-md">
      ...
      {/* Hair */}
      <path d="M215 222 Q218 195 240 193 Q265 193 265 215 Q260 205 240 207 Q220 207 215 222Z" fill="#1a1a2e"/>
      <path d="M265 215 Q270 240 260 255 Q265 230 260 220Z" fill="#1a1a2e"/>
    </svg>
  );
}